      ...
      9688: (e, r, o) => {
         ...
         let t = e => {
            ...
            u = e => {
               let {
                  ...
                  let s = 0 === o.length ? e : e.substring(l),
                     a = b(s);
                  return {
                     modifiers: o,
            ...
            b = e => e.endsWith("!") ? e.substring(0, e.length - 1) : e.startsWith("!") ? e.substring(1) : e,
            f = e => {
         ...
         let ep = function (e, ...r) {
            ...
            let e = v("color"),
               ...
               k = () => ["auto", "contain", "none"],
               z = () => [P, "px", "full", "auto", H, R, i],
               j = () => [G, "none", "subgrid", H, R],
               N = () => ["auto", {
                  span: ["full", G, H, R]
               }, H, R],
               C = () => [G, "auto", H, R],
               M = () => ["auto", "min", "max", "fr", H, R],
               E = () => [H, R, i],
               W = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline"],
               _ = () => ["start", "end", "center", "stretch"],
               O = () => [H, R, i],
               L = () => ["px", ...O()],
               ee = () => ["px", "auto", ...O()],
               er = () => [P, "auto", "px", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", H, R, i],
               eo = () => [e, H, R],
               et = () => [I, B],
               en = () => ["", "none", "full", d, H, R],
               el = () => ["", $, J, B],
               ...
               ei = () => ["", "none", b, H, R],
               ed = () => ["center", "top", "top-right", "right", "bottom-right", "bottom", "bottom-left", "left", "top-left", H, R],
               ec = () => ["none", $, H, R],
               ep = () => ["none", $, H, R],
               eu = () => [$, H, R],
               eb = () => [P, "full", "px", H, R, i];
            return {
               ...
               classGroups: {
                  ...
                  "font-stretch": [{
                     "font-stretch": ["ultra-condensed", "extra-condensed", "condensed", "semi-condensed", "normal", "semi-expanded", "expanded", "extra-expanded", "ultra-expanded", I, R]
                  }],
                  "font-family": [{
                     font: [K, R, r]
                  }],
                  ...
                  "text-decoration-thickness": [{
                     decoration: [$, "from-font", "auto", H, B]
                  }],
                  "text-decoration-color": [{
                     decoration: eo()
                  }],
                  "underline-offset": [{
                     "underline-offset": [$, "auto", H, R]
                  }],
                  ...
                  "vertical-align": [{
                     align: ["baseline", "top", "middle", "bottom", "text-top", "text-bottom", "sub", "super", H, R]
                  }],
                  whitespace: [{
                  ...
                  transition: [{
                     transition: ["", "all", "colors", "opacity", "shadow", "transform", "none", H, R]
                  }],
                  "transition-behavior": [{
                     transition: ["normal", "discrete"]
                  }],
                  duration: [{
                     duration: [$, "initial", H, R]
                  }],
                  ease: [{
                     ease: ["linear", "initial", g, H, R]
                  }],
                  delay: [{
                     delay: [$, H, R]
                  }],
                  ...
                  cursor: [{
                     cursor: ["auto", "default", "pointer", "wait", "text", "move", "help", "not-allowed", "none", "context-menu", "progress", "cell", "crosshair", "vertical-text", "alias", "copy", "no-drop", "grab", "grabbing", "all-scroll", "col-resize", "row-resize", "n-resize", "e-resize", "s-resize", "w-resize", "ne-resize", "nw-resize", "se-resize", "sw-resize", "ew-resize", "ns-resize", "nesw-resize", "nwse-resize", "zoom-in", "zoom-out", H, R]
                  }],
                  "field-sizing": [{
                  ...
                  "will-change": [{
                     "will-change": ["auto", "scroll", "contents", "transform", H, R]
                  }],
                  fill: [{
                     fill: ["none", ...eo()]
                  }],
