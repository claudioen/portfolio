(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
   [893], {
      285: (e, r, t) => {
         ...
         var n = t(5155),
            ...
            s = t(2085),
            i = t(9434);
         let o = (0, s.F)("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0", {
               variants: {
                  variant: {
      ...
      2085: (e, r, t) => {
         ...
         let l = e => "boolean" == typeof e ? `${e}` : 0 === e ? "0" : e,
            ...
            s = (e, r) => t => {
               ...
               return a(e, o, null == r || null == (n = r.compoundVariants) ? void 0 : n.reduce((e, r) => {
                  let {
                     class: t,
                     className: n,
                     ...l
      ...
      2102: (e, r, t) => {
         Promise.resolve().then(t.bind(t, 8057))
      },
      2523: (e, r, t) => {
         "use strict";
         t.d(r, {
               ...
               let r = function (e) {
                     let r = n.forwardRef((e, r) => {
                        ...
                        if (n.isValidElement(t)) {
                           var s;
                           let e, i, o = (s = t, (i = (e = Object.getOwnPropertyDescriptor(s.props, "ref")?.get) && "isReactWarning" in e && e.isReactWarning) ? s.ref : (i = (e = Object.getOwnPropertyDescriptor(s, "ref")?.get) && "isReactWarning" in e && e.isReactWarning) ? s.props.ref : s.props.ref || s.ref),
                              d = function (e, r) {
                                 let t = {
                                    ...r
                                 };
                                 for (let n in r) {
                                    let l = e[n],
                                       a = r[n];
                                    /^on[A-Z]/.test(n) ? l && a ? t[n] = (...e) => {
                                       let r = a(...e);
                                       return l(...e), r
                                    } : l && (t[n] = l) : "style" === n ? t[n] = {
                                       ...l,
                                       ...a
                                    } : "className" === n && (t[n] = [l, a].filter(Boolean).join(" "))
                                 }
                                 return {
                                    ...e,
                                    ...t
                           ...
                           return t.type !== n.Fragment && (d.ref = r ? function (...e) {
                              return r => {
                                 let t = !1,
                                    n = e.map(e => {
                                       let n = l(e, r);
                  ...
                  t = n.forwardRef((e, t) => {
                     let {
                        children: l,
                        ...s
                     } = e, i = n.Children.toArray(l), d = i.find(o);
                     if (d) {
                        let e = d.props.children,
                           l = i.map(r => r !== d ? r : n.Children.count(e) > 1 ? n.Children.only(null) : n.isValidElement(e) ? e.props.children : null);
                        return (0, a.jsx)(r, {
                           ...s,
                           ref: t,
      ...
      6126: (e, r, t) => {
         ...
         var l = t(2085),
            a = t(9434);
         let s = (0, l.F)("inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2", {
            variants: {
               variant: {
      ...
      8057: (e, r, t) => {
            ...
            return r.url && c(), (0, n.jsxs)(i.Zp, {
               ...
               children: [(0, n.jsx)("div", {
                  ...
                  children: (0, n.jsx)(s(), {
                     ...
                     "data-ai-hint": r.image.hint
                  })
               }), (0, n.jsxs)("div", {
                  className: "flex flex-col flex-grow p-6",
                  children: [(0, n.jsx)(i.aR, {
                     className: "p-0 mb-2",
                     children: (0, n.jsx)(i.ZB, {
                        className: "font-headline text-2xl",
                        children: r.title
                     })
                  }), (0, n.jsx)(i.Wu, {
                     className: "p-0 flex-grow",
                     children: (0, n.jsx)(i.BT, {
                        children: r.description
                     })
                  })]
               }), (0, n.jsxs)(i.wL, {
                  className: "flex-col items-start gap-4 p-6 pt-0",
                  children: [(0, n.jsx)("div", {
                     className: "flex flex-wrap gap-2",
                     children: r.tags.map(e => (0, n.jsx)(o.E, {
                        variant: "secondary",
                        children: e
                     }, e))
                  }), r.url && (0, n.jsxs)(c(), {
                     href: r.url,
                     className: "text-sm font-semibold text-accent hover:text-accent/80 flex items-center group",
                     target: "_blank",
                     rel: "noopener noreferrer",
                     children: ["View Project ", (0, n.jsx)(u.A, {
                        className: "h-4 w-4 ml-1 transform transition-transform group-hover:-translate-y-0.5 group-hover:translate-x-0.5"
                     })]
                  })]
               })]
            })
         ...
         var p = t(2523),
            m = t(285),
            g = t(5074);
         let v = ["All", "Dashboards", "Automation", "Case Studies"];

         function x(e) {
            let {
               projects: r
            } = e, [t, a] = (0, l.useState)(""), [s, i] = (0, l.useState)("All"), o = (0, l.useMemo)(() => r.filter(e => {
               let r = "All" === s || e.category === s,
                  n = e.title.toLowerCase().includes(t.toLowerCase()) || e.description.toLowerCase().includes(t.toLowerCase()) || e.tags.some(e => e.toLowerCase().includes(t.toLowerCase()));
               return r && n
            }), [r, t, s]);
            return (0, n.jsxs)("div", {
               children: [(0, n.jsxs)("div", {
                  ...
                  children: o.map((e, r) => (0, n.jsx)("div", {
                  ...
                  children: (0, n.jsx)("p", {
                     ...
                     children: "No projects found. Try a different search or filter."
                  })
               })]
            })
         }
   ...
   e => {
      var r = r => e(e.s = r);
      e.O(0, [769, 874, 63, 441, 684, 358], () => r(2102)), _N_E = e.O()
   }
]);
